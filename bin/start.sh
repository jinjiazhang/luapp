...
./luapp --id=1.1.5.1 --main-file=lobby/main.lua --log-conf=config/lobby-linux.properties --daemon
./luapp --id=1.1.6.1 --main-file=gateway/main.lua --log-conf=config/gateway-linux.properties --daemon
