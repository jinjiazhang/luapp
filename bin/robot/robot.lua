...
function texas_flow( openid, token )
	...
	local roomid, hand_idx, round_idx, start_time, cards = notify.wait_for_notify("texas_deal")
	log_info("texas_deal", roomid, hand_idx, round_idx, start_time, app.tostring(cards))
